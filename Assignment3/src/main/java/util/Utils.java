...
public class Utils {
	...
	public static MapResponse_String_Integer hashMapIntToWebServiceResponse(HashMap<String, Integer> result) {
		MapResponse_String_Integer r = new MapResponse_String_Integer();
		r.setCourseList(result);
		return r;
	}
	
	public static Map<String,ArrayList<String>> convertToHashMap_String_ArrayList(MapResponse_String_StringArray m){
	
		Map<String,ArrayList<String>> result = new HashMap<>();
		for (Map.Entry<String, String[]> entry : m.getClassSchedule().entrySet()) {
			result.put(entry.getKey(), new ArrayList<String>(Arrays.asList(entry.getValue())));
		}
		return result;
	}
	
	public static Map<String,ArrayList<String>> convertToHashMap_String_ArrayList(Map<String,String[]> m){
	...
	public static Map<String,String[]> convertToHashMap_String_StringArray(Map<String, ArrayList<String>> m){
		Map<String,String[]> result = new HashMap<>();
		
		for (Map.Entry<String, ArrayList<String>> entry : m.entrySet()) {
			String[] list = new String[entry.getValue().size()];
			result.put(entry.getKey(), entry.getValue().toArray(list));
		}
		return result;
