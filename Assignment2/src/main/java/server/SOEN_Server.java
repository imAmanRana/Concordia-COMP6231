...
/**
 * <b>Software Engineering Department Server</b> <br>
 * SOEN
 * 
...
public class SOEN_Server {
	...
	public static void main(String[] args) throws RemoteException {
		...
		try {
			...
			stub = new EnrollmentImpl("SOEN", orb);
			...
			NameComponent path[] = ncRef.to_name(Department.SOEN.toString());
			...
			LOGGER.info("SOEN Server ready and waiting.....");
			for (;;) {
				orb.run();
			}
