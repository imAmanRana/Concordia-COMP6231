...
/**
 * <b>Computer Science Department Server</b> <br>
 * COMP
 * 
...
public class COMP_Server {
	...
	public static void main(String[] args) throws RemoteException {
		...
		try {
			...
			stub = new EnrollmentImpl("COMP", orb);
			...
			NameComponent path[] = ncRef.to_name(Department.COMP.toString());
			...
			LOGGER.info("COMP Server ready and waiting.....");
			for (;;) {
				orb.run();
			}
